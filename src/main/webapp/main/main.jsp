	...
	<div id="wrap">
		...
		function validateForm(form)
		{
			...
			<div class="main_con_left">
				<form action="../member/LoginProcess.jsp" name="loginFrm" method="post" onsubmit="return validateForm(this);">
				...
				<div class="login_box">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td><input type="text" name="userId" value="<%= loginId %>" class="login_input" /></td>
							<td rowspan="2"><input type="image" src="../images/login_btn01.gif" alt="로그인" /></td>
						</tr>
						<tr>
							<th><img src="../images/login_tit02.gif" alt="패스워드" /></th>
							<td><input type="password" name="userPwd" value="" class="login_input" /></td>
						</tr>
					</table>
					<p>
		...
		<div class="main_con_left">
			<p style="padding:10px 0px 10px 10px">
				<span style="font-weight:bold; color:#333;"><%= userName %>님</span> 반갑습니다.<br />
				로그인 하셨습니다.
			</p>
			<p style="text-align:right; padding-right:10px;">
				<a href="../member/MemberEdit.jsp"><img src="../images/login_btn04.gif" /></a>
