		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<div class="con_box">
					...
					<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=87fbf6a3727fb2cf550e7f149d665b0d"></script>
					<script>
						var mapContainer = document.getElementById('map'), 
					    mapOption = { center: new kakao.maps.LatLng(37.584112, 126.912623), level: 3 };
						var map = new kakao.maps.Map(mapContainer, mapOption);
						var markerPosition  = new kakao.maps.LatLng(37.584112, 126.912623); 
