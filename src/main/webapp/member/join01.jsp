...
<script>
function send(f) {
	if(f.agreement1 == true) {
		return true;
	}
	else {
		alert("약관 동의후 회원가입이 가능합니다.");
		return false;
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px;"><input type="checkbox" name="agreement1"/>이용약관과 개인정보취급방침에 동의합니다.</p>

				<p style="text-align:center; margin-bottom:20px"><a href="join02.jsp" ><img src="../images/btn01.gif" onclick="send(this);"></a>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
