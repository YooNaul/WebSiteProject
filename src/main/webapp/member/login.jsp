				...
				<div class="login_box01">
					...
					<ul>
						<li>
							...
							<input type="text" name="userId" value="" class="login_input01" />
						</li>
						<li>
							<img src="../images/login_tit002.gif" alt="비밀번호" style="margin-right:15px;" />
							<input type="password" name="userPwd" value="" class="login_input01" />
						</li>
					</ul>
					<a><input type="image" src="../images/login_btn.gif" class="login_btn01" alt="로그인" /></a>
				</div>
			</form>
				<p style="text-align:center; margin-bottom:50px;"><a href=""><img src="../images/login_btn02.gif" alt="아이디/패스워드찾기" /></a>&nbsp;<a href="./join01.jsp"><img src="../images/login_btn03.gif" alt="회원가입" /></a></p>
			</div>
		</div>
